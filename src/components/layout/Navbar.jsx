...
const DROPDOWNS = {
  ...
  individuals: {
    ...
    promo: {
      bg: '#F0F9FF',
      illus: (
        <img src={navigationUpsell} alt="Built for everyone" style={{ width: '100%', borderRadius: 12, display: 'block' }} />
      ),
  ...
  businesses: {
    ...
    promo: {
      bg: '#F0FDF4',
      illus: (
        <img src={onchainPayment} alt="Grow with crypto" style={{ width: '100%', borderRadius: 12, display: 'block' }} />
      ),
  ...
  institutions: {
    ...
    promo: {
      bg: '#fff',
      illus: (
        <img src={institutionsUpsell} alt="Our clients" style={{ width: '100%', borderRadius: 12, display: 'block' }} />
      ),
      title: 'Our clients',
  ...
  developers: {
    ...
    promo: {
      bg: '#F5F3FF',
      illus: (
        <img src={developersUpsell} alt="Build onchain" style={{ width: '100%', borderRadius: 12, display: 'block' }} />
      ),
      title: 'Build onchain',
  ...
  company: {
    ...
    promo: {
      bg: '#FFF7ED',
      illus: (
        <img src={companyUpsell} alt="Our mission" style={{ width: '100%', borderRadius: 12, display: 'block' }} />
      ),
      title: 'Our mission',
